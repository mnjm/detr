...
def main(cfg):
    ...
    wb_logger = WandBLogger(
        ...
        tags=("train", "val"),
        metrics=("loss", "loss_cls", "loss_l1", "loss_giou", "time", "cls_acc_matched", "mean_iou", "match_ratio", "bg_ratio"),
        run_id=wandb_id,
    ...
    def train_epoch():
        ...
        metrics = DeTRMetrics(model_cfg.background_cls_idx)
        ...
        for step, batch in enumerate(progress_bar):
            ...
            metrics.update(pred_cls_probs, pred_bboxes, tgts)
        ...
        return {
            'loss': loss.avg, 'loss_cls': loss_cls.avg, 'loss_l1': loss_l1.avg, 'loss_giou': loss_giou.avg,
        } | metrics.compute()
